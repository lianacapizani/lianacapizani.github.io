...
const projectsData = [
  ...
  },
  {
    ...
    demoLink: "",
    startDate: "04 Abr 2024",
    status: "Completed",
    technologies: ["ReactJS", "HTML", "CSS"]
  }
];

const categories = ["All", "UX/UI Design", "UI Design", "Front-End"];
